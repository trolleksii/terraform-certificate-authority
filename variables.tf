...
variable "ca_cert_file" {
  type        = string
  description = "Wneh `create_ca` is false, the absolute or relative path to the CA certificate file. Defaults to `ca.crt`."
  default     = "ca.crt"
}

variable "ca_pkey_file" {
  type        = string
  description = "Wneh `create_ca` is false, the absolute or relative path to the CA private key file. Defaults to `ca.key`."
  default     = "ca.key"
}
